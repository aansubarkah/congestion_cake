...
class ReviewsController extends AppController
{
    ...
    public function add()
    {
        ...
        $raws = $this->Reviews->Raws->find('list', ['limit' => 200]);
        $errors = $this->Reviews->Errors->find('list', ['limit' => 200]);
        $users = $this->Reviews->Users->find('list', ['limit' => 200]);
        $this->set(compact('review', 'raws', 'errors', 'users'));
        $this->set('_serialize', ['review']);
    }
