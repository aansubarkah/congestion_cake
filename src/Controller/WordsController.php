 ...
 *
 * @method \App\Model\Entity\Word[] paginate($object = null, array $settings = [])
 */
class WordsController extends AppController
{
    ...
    public function view($id = null)
    {
        $word = $this->Words->get($id, [
            'contain' => ['Ts', 'Tags', 'Users', 'Syllables']
        ]);
